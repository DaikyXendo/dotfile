...
def _draw_left_status(
    ...
    # with open(
    #     "/Users/thanhlevan/.config/kitty/temp.txt", "w", encoding="utf-8"
    # ) as file:
    #     a = str(draw_data) + "\n\n" + "\n\n" + str(tab)
    #     a = a.replace(", ", ",\n\t")
    #     file.write(a)

    # if tab.title == "e" or tab.title.startswith("e "):
    #     tab = TabBarData(
    #         title=" nvim",
    #         is_active=True,
    ...
    #     )
    # elif (
    #     tab.title.startswith("npm")
    #     or tab.title.startswith("yarn")
    #     or tab.title.startswith("node")
    #     or tab.title.startswith("npx")
    # ):
    #     tab = TabBarData(
    #         title="󰎙 " + tab.title,
    #         is_active=True,
    ...
    #         inactive_bg=None,
    #     )
    # elif tab.title.startswith("cargo"):
    #     tab = TabBarData(
    #         title="󱘗 " + tab.title,
    #         is_active=True,
    #         needs_attention=False,
    ...
    #         inactive_bg=None,
    #     )
    # elif tab.title.startswith("thanhlevan@Thanhs-MacBook-Pro"):
    #     start = tab.title.rfind("/")
    #     new_title = " " + tab.title[start + 1 :]
    #     tab = TabBarData(
    #         title=new_title,
    #         is_active=True,
    #         needs_attention=False,
